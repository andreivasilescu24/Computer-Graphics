...
namespace implemented
{
    class Camera_t2
    {
     public:
        ...
        {
            // Translates the Camera_t2 using the `dir` vector computed from
            // `forward`. Movement will always keep the Camera_t2 at the same
        ...
        {
            // TODO(student): Translate the Camera_t2 using the `forward` vector.
        ...
        {
            // TODO(student): Translate the Camera_t2 using the `up` vector.
        ...
        void TranslateRight(float distance)
        {
            ...
            // You need to translate the Camera_t2 using the `right` vector.
            // Usually, however, translation using Camera_t2's `right` vector
            // is not very useful, because if the Camera_t2 is rotated around the
            // `forward` vector, then the translation on the `right` direction
            // will have an undesired effect, more precisely, the Camera_t2 will
            ...
            // same distance from the ground plane.v
        ...
        {
            // TODO(student): Rotate the Camera_t2 in third-person mode around
