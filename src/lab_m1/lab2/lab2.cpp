...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        vector<VertexFormat> vertices_p
        {
            VertexFormat(glm::vec3(5, 0, 5), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
           VertexFormat(glm::vec3(5, 0, 7), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
           VertexFormat(glm::vec3(3, 0, 7), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
           VertexFormat(glm::vec3(3, 0, 5), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
           VertexFormat(glm::vec3(4, 4, 6), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6))
        };
        ...
        vector<unsigned int> indices_clock =
        {
            
        };
        
        
        vector<unsigned int> indices_p =
        {
            4, 0, 1,
            4, 1, 2,
            4, 2, 3,
        ...
        CreateMesh("p", vertices_p, indices_p);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-2, 0.5f, 1), glm::vec3(0.25f));
    RenderMesh(meshes["p"], shaders["VertexColor"], glm::vec3(-3, 0.5f, 2), glm::vec3(0.25f));
